  ...
  <script>
    ...
    function snapshotHtml(summary) {{
      ...
      if (summary.geometry_type === 'MultiArea') {{
        return '<div class="snap-grid"><div class="snap-card"><div class="snap-label">Selected Geometry</div><div class="snap-value">Multi-area</div><div class="snap-sub">' + summary.number_of_search_areas + ' areas captured.</div></div><div class="snap-card"><div class="snap-label">Total Area</div><div class="snap-value">' + summary.total_area_km2 + ' sq km</div><div class="snap-sub">Each area receives its own lane plan.</div></div><div class="snap-card"><div class="snap-label">METOC samples</div><div class="snap-value">' + summary.representative_points.length + '</div><div class="snap-sub">Area centroid lookup points.</div></div></div>';
      }}
