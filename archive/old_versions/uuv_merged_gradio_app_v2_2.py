...
USER_AGENT = "uuv-capstone-gradio/0.22 (planning-scale research tool)"
REQUEST_TIMEOUT = 25
...
def build_mission_and_prefill(mission_type: str, geometry_json_text: str):
    ...
    if mission_type == "Payload Delivery" and geom_type != "line":
        ...
        return (
            ...
            gr.update(), gr.update(), gr.update(visible=False), gr.update(visible=True),
        )
    ...
    if mission_type in SEARCH_MISSIONS and geom_type != "rectangle":
        ...
        return (
            ...
            mission_type,
            gr.update(), gr.update(), gr.update(), gr.update(), gr.update(),
            gr.update(), gr.update(), gr.update(visible=True), gr.update(visible=False),
        )
